#This script will defer the macOS upgrade by 30 days and needs to be deployed via Workspace One. Initially this script will be applied to the group of MacBooks if required, simnce this will only temporarily block the updates
